            ...
            <CardContent>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-umber border-b border-primary-200 pb-2">
                    Contact information
                  </h3>
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-umber mb-2">
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-umber mb-2">
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-sm font-medium text-umber mb-2">
                      Phone number
                    </label>
                    <input
                      id="phone"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="height" className="block text-sm font-medium text-umber mb-2">
                        Height
                      </label>
                      <input
                        id="height"
                    ...
                    <div>
                      <label htmlFor="weight" className="block text-sm font-medium text-umber mb-2">
                        Weight
                      </label>
                      <input
                        id="weight"
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="goals" className="block text-sm font-medium text-umber mb-2">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="breathwork">Breathwork (Pranayama)</option>
                      <option value="meditation">Meditation</option>
                      <option value="open">Open to exploring</option>
                    </select>
                  </div>
                  <div>
                    <label
                    ...
                    >
                      ...
                      <optgroup label="Morning">
                        <option value="morning-6-7">6:00 AM – 7:00 AM IST</option>
                        <option value="morning-7-8">7:00 AM – 8:00 AM IST</option>
                        <option value="morning-8-9">8:00 AM – 9:00 AM IST</option>
                      </optgroup>
                      <optgroup label="Evening">
                        <option value="evening-6-7">6:00 PM – 7:00 PM IST</option>
                        <option value="evening-7-8">7:00 PM – 8:00 PM IST</option>
                        <option value="evening-8-9">8:00 PM – 9:00 PM IST</option>
                      </optgroup>
                    </select>
                  </div>
                  <div>
